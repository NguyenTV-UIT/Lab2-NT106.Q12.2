...
namespace Lab2_LTMCB
{
    public partial class Bai5 : Form
    {
        ...
        private string file_in = string.Empty;
        ...
        private void btn_rd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (orders.Count > 0)
                {
                    ...
                    btn_next.Enabled = currentOrderIndex < orders.Count - 1;
                }
                else
                {
        ...
        private void DisplayOrder(int index)
        {
            ...
            tb_cinema.Text = order.RoomNumber;
            tb_ticketnum.Text = order.TicketCount.ToString();
            ...
            btn_next.Enabled = index < orders.Count - 1;
        }
